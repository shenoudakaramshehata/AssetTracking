...
{
    public partial class rptAssetEdited : DevExpress.XtraReports.UI.XtraReport
    {
        public Tenant TenantObj { get; set; }
        public rptAssetEdited(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptAssetEdited_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
