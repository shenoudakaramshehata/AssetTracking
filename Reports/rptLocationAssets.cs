...
{
	public partial class rptLocationAssets : DevExpress.XtraReports.UI.XtraReport
	{
        public Tenant TenantObj { get; set; }
        public rptLocationAssets(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptLocationAssets_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
    }
