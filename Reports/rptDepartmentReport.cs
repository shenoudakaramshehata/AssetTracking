...
{
    public partial class rptDepartmentReport : DevExpress.XtraReports.UI.XtraReport
    {
        public Tenant TenantObj { get; set; }
        public rptDepartmentReport(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptDepartmentReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
