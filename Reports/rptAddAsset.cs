...
{
    public partial class rptAddAsset : DevExpress.XtraReports.UI.XtraReport
    {
        public Tenant TenantObj { get; set; }
        public rptAddAsset(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptAddAsset_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
