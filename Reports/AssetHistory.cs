...
{
	public partial class AssetHistory : DevExpress.XtraReports.UI.XtraReport
	{
        public Tenant TenantObj { get; set; }
        public AssetHistory(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void AssetHistory_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
    }
