...
{
    public partial class rptStoreIncomeHistory : DevExpress.XtraReports.UI.XtraReport
    {
        public Tenant TenantObj { get; set; }

        public rptStoreIncomeHistory(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptStoreIncomeHistory_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
