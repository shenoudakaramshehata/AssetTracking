...
{
    public partial class rptAssetBrocken : DevExpress.XtraReports.UI.XtraReport
    {
        public Tenant TenantObj { get; set; }
        public rptAssetBrocken(Tenant tenant)
        {
            InitializeComponent();
            TenantObj = tenant;
        }
        ...
        private void rptAssetBrocken_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            LoadTalent();
        }
